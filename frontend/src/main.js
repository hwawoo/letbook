...
pluralCaseList.push( {plural: "bookRents", pascal: "BookRent"} )


pluralCaseList.push( {plural: "rentalHists", pascal: "RentalHist"} )
pluralCaseList.push( {plural: "bookStores", pascal: "BookStore"} )
